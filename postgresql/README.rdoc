...
Tested on Scientific 6.1, Debian 6.0 but should support centos, redhat, fedora, scientific, suse, ubuntu and debian.
...
Author:: OKINAKA Kenshin

Original Author:: Joshua Timberam (<joshua@opscode.com>)
